...
dist: clean
	...
	wget -q https://cdnjs.cloudflare.com/ajax/libs/jquery/3.1.0/jquery.min.js -O dist/j.js
	wget -q https://cdnjs.cloudflare.com/ajax/libs/semantic-ui/2.2.4/semantic.min.js -O dist/s.js
	wget -q https://cdnjs.cloudflare.com/ajax/libs/zepto/1.2.0/zepto.min.js -O dist/z.js
	wget -q https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.14.1/moment.min.js -O dist/m.js
