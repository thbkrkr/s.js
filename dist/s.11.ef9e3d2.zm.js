...
"{"===value[0]&&(value=JSON.parse(value));return value};this.$lsRm=function(a){localStorage.removeItem(a)};this.$scrollToBottom=function(a,b){function d(){var a=Math.min(1,(Date.now()-g)/b);c.scrollTop=f*a+e;1>a&&setTimeout(d,10)}var c=a[0],e=c.scrollTop,f=c.scrollHeight-a.height()-e,g=Date.now();d()};this.$setElementHeight=function(a,b){$(a).height($(window).height()-b)};var g=0;this.$ws=function(a,b,d,c){wsProto="ws:";"https:"==window.location.protocol&&(wsProto="wss:");ws=new WebSocket(wsProto+
"//"+window.location.host+a);ws.onopen=function(){g=1;b(a,b)};ws.onmessage=function(a){c(a)};ws.onclose=function(e){e=1E3*Math.min(15,Math.pow(2,g)-1);d(e);setTimeout(function(){g++;ws=$ws(a,b,d,c)},e)};return ws}})();
